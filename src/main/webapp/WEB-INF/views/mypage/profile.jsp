        ...
        <div class="mypage_main">
                ...
                <div class="profile_card_body">
                    ...
                    <div class="profile_information">
                        ...
                        <div class="profile_name_row">
                            <h3>
                                <c:choose>
                                    <c:when test="${not empty loginMember.nickname}">
                        ...
                        <dl class="profile_detail_list">
                            ...
                            <div class="profile_detail_item">
                                ...
                                <dd>
                                    <c:choose>
                                        <c:when test="${not empty loginMember.email}">
                                            <c:out value="${loginMember.email}"/>
                                        </c:when>
            ...
            <span class="section_eyebrow">
                ...
                →
                    ...
                    <!-- 추후 구현할 뱃지 보관함 카드 -->
                    <div class="quick_menu_card quick_menu_card_disabled">
