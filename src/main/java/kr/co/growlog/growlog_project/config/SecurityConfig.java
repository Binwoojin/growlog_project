...
import kr.co.growlog.growlog_project.security.LoginSuccessHandler;
...
public class SecurityConfig {
        /*
         * Spring Security 인증 성공 후 실행할 Handler
         * 현재는 기존 Controller와의 호환을 위해
         * loginMember 세션 속성을 임시로 저장하는 역할도 담당
         */
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests(authorize -> authorize
                        .requestMatchers("/goal/**", "/record/**", "/home", "/timeline", "/mypage/**", "/api/member/check-nickname-update").authenticated()
